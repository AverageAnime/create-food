...
public class ChocolateCreamCakeDarkChocolateBlock extends CakeBlock {

    public final Item cakeSlice;

    public ChocolateCreamCakeDarkChocolateBlock(Item pieSlice) {
    ...
    protected static ActionResult tryEat(WorldAccess world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!player.canConsume(false)) {
            ...
            player.getHungerManager().add(5, 0.2F);
            player.addStatusEffect(new StatusEffectInstance(ModEffects.COMFORT.get(), 1200, 0));
