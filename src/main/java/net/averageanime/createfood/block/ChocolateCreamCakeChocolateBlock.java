...
public class ChocolateCreamCakeChocolateBlock extends CakeBlock {

    public final Item cakeSlice;

    public ChocolateCreamCakeChocolateBlock(Item pieSlice) {
    ...
    protected static ActionResult tryEat(WorldAccess world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!player.canConsume(false)) {
            ...
            player.addStatusEffect(new StatusEffectInstance(ModEffects.COMFORT.get(), 600, 0));
