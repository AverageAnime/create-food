...
public abstract class CaramelFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_CARAMEL;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_CARAMEL;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.CARAMEL_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.CARAMEL_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
