...
public abstract class ButterscotchFluid extends FlowableFluid {
    @Override
    ...
    public Item getBucketItem() {
        return ModFluids.BUTTERSCOTCH_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.BUTTERSCOTCH_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
