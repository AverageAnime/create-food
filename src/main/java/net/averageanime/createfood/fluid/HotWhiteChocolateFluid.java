...
public abstract class HotWhiteChocolateFluid extends FlowableFluid {
    @Override
    ...
    public Fluid getStill() {
        return ModFluids.STILL_HOT_WHITE_CHOCOLATE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_HOT_WHITE_CHOCOLATE;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.HOT_WHITE_CHOCOLATE_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.HOT_WHITE_CHOCOLATE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends HotWhiteChocolateFluid {
        @Override
    ...
    public static class Still extends HotWhiteChocolateFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
