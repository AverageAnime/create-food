...
public class ModFluids {
    ...
    public static boolean isCaramelPudding(FluidState state) {
        return state.isOf(ModFluids.STILL_CARAMEL_PUDDING) || state.isOf(ModFluids.FLOWING_CARAMEL_PUDDING);
    }
    public static boolean isChocolatePudding(FluidState state) {
        return state.isOf(ModFluids.STILL_CHOCOLATE_PUDDING) || state.isOf(ModFluids.FLOWING_CHOCOLATE_PUDDING);
    }
    public static boolean isButterscotchPudding(FluidState state) {
        return state.isOf(ModFluids.STILL_BUTTERSCOTCH_PUDDING) || state.isOf(ModFluids.FLOWING_BUTTERSCOTCH_PUDDING);
    }
    ...
    public static void register(){
        ...
        if (CONFIG.isChocolatePuddingFluidEnabled) {
            ItemGroupEvents.modifyEntriesEvent(CreateFood.GROUP).register(entries -> {
                entries.add(CHOCOLATE_PUDDING_BUCKET);
            });
            STILL_CHOCOLATE_PUDDING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "chocolate_pudding"), new ChocolatePuddingFluid.Still());
            FLOWING_CHOCOLATE_PUDDING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "flowing_chocolate_pudding"), new ChocolatePuddingFluid.Flowing());
            CHOCOLATE_PUDDING_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateFood.MOD_ID, "chocolate_pudding_block"),
                    new FluidBlock(ModFluids.STILL_CHOCOLATE_PUDDING, FabricBlockSettings.copyOf(Blocks.WATER)) {
                    });
            CHOCOLATE_PUDDING_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateFood.MOD_ID, "chocolate_pudding_bucket"),
                    new BucketItem(ModFluids.STILL_CHOCOLATE_PUDDING, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));
        }
        if (CONFIG.isCaramelPuddingFluidEnabled) {
            ItemGroupEvents.modifyEntriesEvent(CreateFood.GROUP).register(entries -> {
                entries.add(CARAMEL_PUDDING_BUCKET);
            });
            STILL_CARAMEL_PUDDING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "caramel_pudding"), new CaramelPuddingFluid.Still());
            FLOWING_CARAMEL_PUDDING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "flowing_caramel_pudding"), new CaramelPuddingFluid.Flowing());
            CARAMEL_PUDDING_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateFood.MOD_ID, "caramel_pudding_block"),
                    new FluidBlock(ModFluids.STILL_CARAMEL_PUDDING, FabricBlockSettings.copyOf(Blocks.WATER)) {
                    });
            CARAMEL_PUDDING_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateFood.MOD_ID, "caramel_pudding_bucket"),
                    new BucketItem(ModFluids.STILL_CARAMEL_PUDDING, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));
        }
        if (CONFIG.isButterscotchPuddingFluidEnabled) {
            ItemGroupEvents.modifyEntriesEvent(CreateFood.GROUP).register(entries -> {
                entries.add(BUTTERSCOTCH_PUDDING_BUCKET);
            });
            STILL_BUTTERSCOTCH_PUDDING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "butterscotch_pudding"), new ButterscotchPuddingFluid.Still());
            FLOWING_BUTTERSCOTCH_PUDDING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "flowing_butterscotch_pudding"), new ButterscotchPuddingFluid.Flowing());
            BUTTERSCOTCH_PUDDING_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateFood.MOD_ID, "butterscotch_pudding_block"),
                    new FluidBlock(ModFluids.STILL_BUTTERSCOTCH_PUDDING, FabricBlockSettings.copyOf(Blocks.WATER)) {
                    });
            BUTTERSCOTCH_PUDDING_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateFood.MOD_ID, "butterscotch_pudding_bucket"),
                    new BucketItem(ModFluids.STILL_BUTTERSCOTCH_PUDDING, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));
        }
