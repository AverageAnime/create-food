...
public abstract class WhiteChocolateFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_WHITE_CHOCOLATE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_WHITE_CHOCOLATE;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.WHITE_CHOCOLATE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
