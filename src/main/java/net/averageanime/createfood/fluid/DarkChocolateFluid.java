...
public abstract class DarkChocolateFluid extends FlowableFluid {
    ...
    public Fluid getStill() {
        return ModFluids.STILL_DARK_CHOCOLATE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.FLOWING_DARK_CHOCOLATE;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.DARK_CHOCOLATE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
